...
export default function OrderSucessScreen() {
  ...
  const { order } = route.params as RouteParam;
      ...
      >
        <VStack justifyContent="space-between" w="80%" mt={20}>
          ...
          >
            ...
            >
              <Box flexGrow={1}>
                <Text fontSize={9} fontWeight="bold" color={colorTextSecondary}>
                  CÓDIGO
                </Text>
                <Text fontWeight="bold" lineHeight={16}>
                  {order.id.split("-")[0]}
                </Text>
              </Box>
              <Text fontSize={12} fontWeight="bold" color={colorTextSecondary}>
                DETALHES DO PEDIDO
              </Text>
            </Box>
            <Box
            ...
            <Box py={3} px="5" width="100%" alignItems="flex-end">
              <Box textAlign="right">
                ...
                <Text fontSize={16} fontWeight="bold" lineHeight={20}>
